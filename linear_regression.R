...
# setwd("C:/Users/Tenaj/Documents/linear-regression-project")
...
energy.mod2 <- lm(energy ~ metro * income, # regression formula
                  data=states.data) # data set
# Summarize and print the results
summary(energy.mod2) # show regression coefficients table

##   2. Try adding region to the model. Are there significant differences
##      across the four regions?  Yes, N. East
energy.mod3 <- lm(energy ~ metro * factor(region), # regression formula
                 data=states.data) # data set
# Summarize and print the results
